...
# Test RTSPSource with NVDEC for CAM1
print('Testing RTSPSource with NVDEC for CAM1...')
try:
    src = create_rtsp_source('CAM1', 'rtsp://127.0.0.1:8554/live/cam1', decoder='nvdec', nvdec_gpu_device=0)
    info = src.open()
    ...
    src.close()
    print('RTSPSource NVDEC CAM1 test PASSED')
except Exception as e:
    print(f'RTSPSource NVDEC CAM1 test FAILED: {e}')
    import traceback
    traceback.print_exc()