  ...
  attendance.setLiveEvents([
    {
      ...
      in_state: 'on_time',
      out_state: 'not_applicable',
      decision_reason: 'Matched known identity within entry window',
      created_at: new Date().toISOString(),
      persisted_at: new Date().toISOString(),
    },
    {
      attendance_record_id: 'evt_1',
      ...
      direction: 'in',
      identity_certainty: 'known',
      identity_candidate: 'HS004',
      identity_confidence: 0.956,
