...
**Timestamp:** 2026-08-24T13:12:20.722263Z
...
- **Checks Verified:** 14
- **Checks Not Verified:** 9
- **LIVE_RUNTIME_VERIFIED:** 11
- **OFFLINE_VERIFIED:** 4
- **NOT_VERIFIED:** 8
- **Total Duration:** 113.09s
...
- **ai_cam1**: ✗ NOT VERIFIED (NOT_VERIFIED)

- **ai_cam2**: ✗ NOT VERIFIED (NOT_VERIFIED)
...
- **fps_runtime**: ✓ VERIFIED (LIVE_RUNTIME_VERIFIED)
  - expected_fps: 30.0
  - tolerance: 1.0
  - cam1_actual_fps: 30.0
...
- **cross_camera**: ✗ NOT VERIFIED (NOT_VERIFIED)

- **in_out_events**: ✗ NOT VERIFIED (NOT_VERIFIED)

- **attendance**: ✗ NOT VERIFIED (NOT_VERIFIED)

- **immediate_event**: ✗ NOT VERIFIED (NOT_VERIFIED)

- **live_ui**: ✗ NOT VERIFIED (NOT_VERIFIED)
  - ui_files_exist: False
  - files: ['frontend/src/App.jsx', 'frontend/src/components/LiveView.jsx', 'frontend/src/components/CameraFeed.jsx']
  - note: Live UI components present; live data integration not tested
...
CAM1 FRAME FLOW: NOT_VERIFIED

CAM2 FRAME FLOW: NOT_VERIFIED

H.264: LIVE_RUNTIME_VERIFIED

RESOLUTION: LIVE_RUNTIME_VERIFIED

FPS: LIVE_RUNTIME_VERIFIED
...
CROSS-CAMERA: NOT_VERIFIED

IN/OUT: NOT_VERIFIED

ATTENDANCE: NOT_VERIFIED

IMMEDIATE EVENT: NOT_VERIFIED

LIVE UI: NOT_VERIFIED
