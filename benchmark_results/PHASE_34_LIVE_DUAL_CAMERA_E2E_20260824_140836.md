...
**Timestamp:** 2026-08-24T14:06:44.645332Z
...
- **Checks Verified:** 18
- **Checks Not Verified:** 5
- **LIVE_RUNTIME_VERIFIED:** 13
- **OFFLINE_VERIFIED:** 6
- **NOT_VERIFIED:** 4
- **Total Duration:** 111.56s
...
- **live_ui**: ✗ NOT VERIFIED (NOT_VERIFIED)
  ...
  - files: ['frontend/src/App.vue', 'frontend/src/components/LiveDashboard.vue', 'frontend/src/components/CameraCard.vue', 'frontend/src/views/LiveDashboard.vue']
